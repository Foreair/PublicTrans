...
class _Astargui:
    ...
    def __init__(self, master):
        ...
        #WINDOW DEFINITION
        frame = Frame(master, width=1300, height=900) #Por defecto 1300, 900
        frame.pack()
        self.master = master
        ...
        self.Button_Calculate.place(x=552, y=790, width=117, height=28)
        ...
        self.Button_Quit.place(x=732, y=790, width=117, height=28)
        ...
        #self.Button_Update_City.bind("<ButtonRelease-1>",
        #self.Button_Update_City())
    ...
    #Button_Update_City : Button "Actualitzar informacio Ciutat" calls this
    #function.
    #                     It reads the corresponding files and update the City
    ...
    #                     It Execute AStar Algorithm [from CercaInformada.py] and
    #                     shows the optimal path found.
    def Button_Calculate_Click(self, event): 
        #pass
        #Delete current NodeList Information from previous searches
        self.Text_NodeList.delete('0.0',END)
        #Delete current Path Information from previous searches
    ...
    #Update_Resultant_Path : It update the output messages [Information] to the
    #GUI
    ...
    #                                 It updates the preference selected by the
    #                                 user
